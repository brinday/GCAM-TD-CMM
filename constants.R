...
energy.RSRC_MINERAL            <- c("steel", "aluminium", "silicon", "copper", "graphite", "lithium", "cobalt", "nickel", "manganese", "neodymium", "tellurium", "vanadium")
...
energy.NEG_EMISS_GDP_BUDGET_PCT <- 0.04 # Max fraction of GDP which may be given to subsidize net negative emissions
